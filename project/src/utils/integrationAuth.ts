export const getAuthUrl = (provider: string): string => {
  ...
  const authUrls: Record<string, string> = {
    ...
    'youtube': `https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=${import.meta.env.VITE_YOUTUBE_CLIENT_ID || googleClientId}&redirect_uri=${encodeURIComponent(redirectUri)}&scope=https://www.googleapis.com/auth/youtube.readonly`,
