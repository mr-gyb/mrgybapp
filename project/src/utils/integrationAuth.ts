export const getAuthUrl = (provider: string): string => {
  ...
  const authUrls: Record<string, string> = {
    ...
    'youtube': `https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=${import.meta.env.VITE_YOUTUBE_CLIENT_ID}&redirect_uri=${redirectUri}&scope=https://www.googleapis.com/auth/youtube.readonly+https://www.googleapis.com/auth/yt-analytics.readonly`,
