    ...
    try {
      ...
      if (status.status === 'connected') {
        ...
        try {
          ...
          const permissions = await facebookIntegrationService.checkUserPermissions();
                  ...
                  <div className="flex space-x-2">
                    ...
                    {checkFacebookConfig().isValid && (
                      <button
                        onClick={() => {
                          try {
                            const oauthUrl = facebookIntegrationService.getOAuthUrl();
                        ...
                        title="Open Facebook OAuth in new tab"
                      >
                        🔗 Manual Auth
                      </button>
                    )}
        ...
        <div className="min-h-[400px]">
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              {/* User Permissions */}
              {connectedAccount && userPermissions.length > 0 && (
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-xs text-gray-500 mt-3">
                    These permissions allow you to post content and manage your Facebook presence.
                  </p>
                </div>
              )}
            </div>
