...
-- Recreate table with consistent column naming
create table public.profiles (
    ...
    experiencelevel integer default 1, -- Changed from experienceLevel to experiencelevel
...
-- Verify the column exists with correct case
do $$
begin
  if not exists (
    select 1 
