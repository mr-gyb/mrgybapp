...
console.log('🔐 Starting dynamic HTTPS proxy server...');

// Generate self-signed certificates dynamically
const generateSelfSignedCert = () => {
  try {
    ...
    const certPem = cert.export({ type: 'spki', format: 'pem' });
    
    console.log('✅ Dynamic SSL certificates generated successfully');
    ...
    console.log('⚠️  Dynamic certificate generation failed, using fallback...');
    
    // Fallback to simple certificates
